...
function DeleteLevelModal ({levelsObj, level, lvls, setLvls, setSelected, idx}) {
    ...
    return (
        <div id="act-delete-modal">
            ...
            <p>Deleting &quot;{level.name}&quot; will remove it form all of your precious entries. Do you still want to mercilessly delete &quot;{level.name}&quot;?</p>
